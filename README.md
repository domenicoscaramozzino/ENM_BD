...
You can use the "ENM_BD.f90" (source code in Fortran) to run BD and sample new protein conformations from an input PDB structure, which you can compare e.g. to MD or NMR ensembles. Reference: https://www.biorxiv.org/content/10.64898/2026.09.22.753665v1
